...
const DEFAULT_TIERS: TierInfo[] = [
  ...
  },
  {
    ...
    price: 97,
    maxBlueprints: 10,
    features: ['10 blueprints per month', 'Full Thinkovr Verum Engine analysis', 'Priority generation', 'Email support'],
  },
  {
    id: '',
    name: 'Premium',
    ...
    price: 297,
    maxBlueprints: 999,
    features: ['Unlimited blueprints', 'Full Thinkovr Verum Engine analysis', 'Instant generation', 'Priority admin review', 'Detailed risk assessment', 'Direct Thinkovr Verum Engine support'],
  },
];
        ...
        >
          ...
          >
            ...
            <p style={{
              ...
              Generated by Thinkovr Verum Engine
            </p>
            <div style={{
